<template>
  <Layout :panel_show.sync="panel_show" title="突击方向绘制-交互绘制">
    ...
    <Collapse title="①工具函数 + ②固定点数图形-公共方法 + ②以下代码，即可完成增删改">
...
export default {
  ...
  watch: {
    curSelect(val) {
      val === "draw-assaultDirection-interact" && (this.panel_show = true);
    }
  },
  beforeDestroy() {
    this.clear();
